const CACHE = "rsl-shell-v5";
const SHELL = ["/", "/demo/", "/privacy/", "/terms/", "/404.html", "/assets/reader-handoff-768.webp", "/assets/social-card.jpg", "/favicon.svg", "/apple-touch-icon.png"];
