...
Audited 2 September 2026 against the landing page, its runtime states, and the demo first screen. Hyphenated terms, paths, URLs, and version strings count as one word.

## Landing page and runtime states
...
| View downloads for your platform | 5 | — |
...
- “per-book inclusion controls” matches the selected-by-default behavior.
...
| Ordered reader folder | collection |
